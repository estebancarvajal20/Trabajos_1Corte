  ...
  <div class="row">
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 active" href="actualizar.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">ACTUALIZA SU INFORMACION:</h1>
        </div>
        <form method="post" action="controladores/base_de_datos_actualizar.php">
            <div>
        ...
        <div>
          ...
          <select name='carrera' class="form-control" id='carrera' required>
            ...
            <input type="submit" value="ACTUALIZAR" class="form-control btn btn-primary w-100 py-2">
          </div>
        </form>
